import type { Tab, User, FamilyRole, LegacyRole } from '../lib/family-hub/constants';
import type { AppSettings } from '../lib/family-hub/storage';
...
export const getRolePermissions = (roleKey: FamilyRole | null): PermissionKey[] => (roleKey ? rolePermissions[roleKey] : []);

export const resolvePermissionBundle = (user: User | null, settings?: PermissionSettings) => {
